...
public class EmployeeEntity {
	...
	@OneToOne(targetEntity = DepartmentEntity.class, optional = true, fetch = FetchType.EAGER)
	...
	public EmployeeEntity(Long id, String firstName, String lastName, String email, String phoneNumber, Date hireDate,
